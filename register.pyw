...
combo_question["values"] = ("Select","Your First Pet Name","Your BIRTH PLACE ","Your Best Friend Name","Your First School Name")
...
def register_data():
	if firstname.get()=="" or lastname.get()=="" or contact.get()=="" or email.get()=="" or question.get()=="Select" or answer.get()=="" or password.get()=="" or confirmpass.get()=="":
		...
		try:
			mydb = pymysql.connect(user='user',host='localhost',password='')
			mycursor = mydb.cursor()
			mycursor.execute("create database if not exists AI_Surveillance_System")
			mycursor.execute("use AI_Surveillance_System")
			mycursor.execute("create table if not exists user (id int(10) auto_increment, primary key(id), f_name varchar(50), l_name varchar(50), contact varchar(10), email varchar(50), question varchar(100), answer varchar(100), password varchar(100))")
